...
const
  ...
  _crypto_pwhash_argon2id_BYTES_MAX = SODIUM_SIZE_MAX;
  ...
  _crypto_pwhash_argon2id_MEMLIMIT_MAX = SODIUM_SIZE_MAX;
  ...
  _crypto_stream_chacha20_IETF_MESSAGEBYTES_MAX = SODIUM_SIZE_MAX;
